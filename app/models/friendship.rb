class Friendship < ApplicationRecord
  ...
  # friendshipの友達だった場合に友達関係を追加しない機能
  # 参考：https://stackoverflow.com/questions/29123620/rails-validate-unique-friendship-relationships
  def users_are_not_already_friends
    combinations = ["from_user_id = #{from_user_id} AND to_user_id = #{to_user_id}",
